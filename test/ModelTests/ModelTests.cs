...
namespace ModelTests
{
    ...
    public class ModelTests
    {
        ...
        public void Given_HighRangeCar_ShouldEstimatePriceWithinRange()
        {
            ...
            var input = new global::Shared.ModelInput
            {
                Year = 2016,
                Mileage = 20422,
                Make = "Lexus",
        ...
        private PredictionEngine<global::Shared.ModelInput, ModelOutput> GetPredictionEngine()
        {
            // var modelPath = MLConfiguration.GetModelPath();
            var modelPath = System.IO.Path.GetFullPath(@"..\..\..\..\..\models\true_car_listings-model.zip");

            var mlContext = new MLContext();

            var model = mlContext.Model.Load(modelPath, out var schema);

            return mlContext.Model.CreatePredictionEngine<global::Shared.ModelInput, ModelOutput>(model, schema);
        }
    }
}
